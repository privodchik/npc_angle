 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Jul 20 16:37:07 2021
 */
...
#define NPARAMS               1
/* Parameter 0 */
#define PARAMETER_0_NAME      _Ts
#define PARAMETER_0_DTYPE     real_T
#define PARAMETER_0_COMPLEX   COMPLEX_NO

#define SAMPLE_TIME_0         _Ts
...
static void mdlCheckParameters(SimStruct *S)
{
...

    {
        ...
        if (!mxIsDouble(pVal0)) {
            ssSetErrorStatus(S, "Sample time parameter _Ts must be of type double");
            return;
        }
    }
...
static void mdlStart(SimStruct *S)
{
    ...
    acs_angle_Start_wrapper(_Ts, p_width0);
}
#endif /*  MDL_START */
